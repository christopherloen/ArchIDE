...
public class newPKG implements ActionListener{
  ...
  public void newPKGGUI(){
    ...
    layout.putConstraint(SpringLayout.NORTH, proceed, 34, SpringLayout.WEST, pkg_arch_text);
    layout.putConstraint(SpringLayout.WEST, proceed, 380, SpringLayout.NORTH, box);
    layout.putConstraint(SpringLayout.NORTH, cancel, 34, SpringLayout.WEST, pkg_arch_text);
    layout.putConstraint(SpringLayout.WEST, cancel, 280, SpringLayout.NORTH, box);
    //frame
  ...
  public void actionPerformed(ActionEvent e){
    ...
    if (e.getSource() == proceed){
      ...
      try(FileReader fr = new FileReader("archide.conf"); BufferedReader br = new BufferedReader(fr);){
        ...
        String id = Files.readAllLines(Paths.get("archide.conf")).get(5);
